...
const pages = [
  { folder: '', file: 'careers.html', title: 'Careers', displayTitle: 'Careers at OmnitraTech' },
    ...
    <section class="py-32 bg-slate-50 relative border-b border-slate-200">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <p class="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Discover how OmnitraTech's tailored approach drives success for your specific operational and strategic needs.
            </p>
        </div>
    </section>
    ...
    <section class="py-24 bg-white min-h-[50vh]">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
             <div class="bg-brand-50 border border-brand-100 rounded-2xl p-16 shadow-inner">
                 ...
                 <p class="text-slate-600 text-lg">We're finalizing the details for this specific offering and industry. Please contact us directly for deep-dive resources or a consultation regarding ${page.displayTitle}.</p>
